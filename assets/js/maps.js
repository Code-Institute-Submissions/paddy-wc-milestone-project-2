...
function mapInteraction(map) {
  ...
  mapInteractionSearchQuery = activities

  addYelpMarkersAndCards(map, marker, mapInteractionSearchQuery)

  // filter buttons functionality
  // adds new yelp markers and cards then scrolls to first new card
  $('.food-and-drink-button').click(function () {
    mapInteractionSearchQuery = foodAndDrink
    addYelpMarkersAndCards(map, marker, mapInteractionSearchQuery)
  })
  ...
  $('.accommodation-button').click(function () {
    mapInteractionSearchQuery = accommodation
    addYelpMarkersAndCards(map, marker, mapInteractionSearchQuery)
  })
...
function addYelpMarkersAndCards(map, marker, searchQuery) {
  ...
  getYelpData(currentLat, currentLng, searchQuery, function (data) {
    ...
    if (searchQuery === foodAndDrink) {
      iconToUse = foodIcon
    } else if (searchQuery === accommodation) {
